// الشعرُ داخل نصّ القيد.
//
// نصُّ القيد نصٌّ مسترسل يُحفظ كما هو، فلا يُبنى له مُحرِّرٌ ذو عُقَد ولا
...
// كاتبَ القيد يعرفها من قبل: هي التي يُنسَخ بها الشعرُ في المنتديات والكتب
// المرقونة. ونموذجُ القيد هو الذي يكتبها، فلا يُطالَب بها الفاهرس.
