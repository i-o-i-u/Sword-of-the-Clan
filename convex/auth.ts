...
// موقع لمستخدم واحد: لا تسجيل عام ولا إنشاء حسابات من الواجهة.
// profile() يُستدعى في كل مسار (تسجيل دخول، إنشاء حساب، إعادة تعيين)، فرفض
// أي بريد غير بريد صاحب المكتبة هنا يغلق الباب على إنشاء حساب ثانٍ من الأصل.
